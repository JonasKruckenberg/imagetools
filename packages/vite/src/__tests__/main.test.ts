...
describe('vite-imagetools', () => {
  ...
  // #bugfix test for import identical files with cache
  // see: https://github.com/JonasKruckenberg/imagetools/issues/839
  // caused by improper concurrency handling when reading/writing cache files
